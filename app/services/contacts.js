 ...
 */
/*globals angular */
angular.module('GRPApp').provider('contactService', function () {
    'use strict';
    ...
    return {
        ...
        $get: function ($q, esriLoader, $mdToast, $filter, relatedFeatureFactory, esriAuth) {
                ...
                Contacts: {
                    ...
                    init: function () {
                        contactService.getContacts().then(function () {
                            contactService.Contacts.layer = new FeatureLayer(config.serviceRoot + config.contactsLayer,
                                {outFields: ["*"]});
                        });
                    },
                    create: function () {
                    ...
                    count: function () {
                        ...
                        contactService.getContacts().then(function () {
                            var query = new Query(), queryTask = new QueryTask(config.serviceRoot + config.contactsLayer);
