...
angular.module('GRPApp')
    .controller('IAPCtrl', function ($scope, $q, iapService, $state, $stateParams, grpService,
                                     $mdDialog, $mdToast, mapService, editService, drawService) {
        "use strict";
        ...
        mapService.getMap().then(function (map) {
            // grpService.Sites.clickListener.remove();
